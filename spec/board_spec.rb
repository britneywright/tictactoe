...
module TicTacToe
  describe Board do
    ...
    context "#get_cell" do
      it "returns the cell based on the (x, y)" do
        grid = [["","",""],["","","something"],["","",""]]
    ...
    context "#game_over" do
      ...
      it "returns :draw if winer? is false and draw? is true" do
        board = Board.new
    ...
    context "#game_over" do
      ...
      it "retuns :winner when row has objects with values that are all the same" do
        grid = [
      ...
      it "retuns :winner when column has objects with values that are all the same" do
        grid = [
